                        ...
                        <div class="blog-details-author">
                            ...
                            <div class="blog-details-author-content">
                                ...
                                <div class="socials">
                                    ...
                                    <a href="http://www.facebook.com" class="social__item" target="_blank">
                                        <img src="{{asset('app/svg/circle-facebook.svg')}}" alt="facebook">
                                    </a>
        
                                    <a href="http://www.twitter.com" class="social__item" target="_blank">
                                        <img src="{{asset('app/svg/twitter.svg')}}"alt="twitter">
                                    </a>
        
                                    <a href="http://www.google.com" class="social__item" target="_blank">
                                        <img src="{{asset('app/svg/google.svg')}}" alt="google">
                                    </a>
        
                                    <a href="http://www.youtube.com" class="social__item" target="_blank">
